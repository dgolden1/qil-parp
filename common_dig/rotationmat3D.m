...
% 
% rotation direction is CCW when looking in the negative direction of the
% axis (i.e., at the "tip" of the rotation axis), i.e., it is right-handed
%
% example:
...
% $Id: rotationmat3D.m 2 2012-08-02 23:59:40Z dgolden $
