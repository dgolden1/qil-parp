function varargout = vennX( data, resolution )
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%     
   ...
   if length( data ) == 3
      ...
      [error, handles] = plot_venn2( data(1), data(2), data(3), resolution, dist );
      error = data - error';
   elseif length( data ) == 7 
       ...
       [error, handles] = plot_venn3( data(1), data(2), data(3), data(4), data(5), data(6), data(7), ...
           resolution, dist_A_B, dist_B_C, dist_A_C );
       error = data - error';
   else
       error('vennX error, data vector must be of length 3 or 7');
   end
...
function varargout = plot_venn3( a, b, c, d, e, f, g, resolution, dist_A_B, dist_B_C, dist_A_C )
    ...
    text_x = mean(j);
    text_y = mean(i);
    handles(1) = text( text_x, text_y, num2str( a ) );
    set( handles(1), 'FontWeight', 'bold' )
    ...
    text_x = mean(j);
    text_y = mean(i);
    handles(2) = text( text_x, text_y, num2str( b ) );
    set( handles(2), 'FontWeight', 'bold' )
    ...
    text_x = mean(j);
    text_y = mean(i);
    handles(3) = text( text_x, text_y, num2str( c ) );
    set( handles(3), 'FontWeight', 'bold' )
    ...
    text_x = mean(j);
    text_y = mean(i);
    handles(4) = text( text_x, text_y, num2str( d ) );
    set( handles(4), 'FontWeight', 'bold' )
    ...
    text_x = mean(j);
    text_y = mean(i);
    handles(5) = text( text_x, text_y, num2str( e ) );
    set( handles(5), 'FontWeight', 'bold' )
    ...
    text_x = mean(j);
    text_y = mean(i);
    handles(6) = text( text_x, text_y, num2str( f ) );
    set( handles(6), 'FontWeight', 'bold' )
    ...
    text_x = mean(j);
    text_y = mean(i);
    handles(7) = text( text_x, text_y, num2str( g ) );
    set( handles(7), 'FontWeight', 'bold' )
