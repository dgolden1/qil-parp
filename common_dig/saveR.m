...
% 
%   Modified by Daniel Golden (dgolden1 at gmail dot com) June 2013
%   $Id: saveR.m 313 2013-06-28 00:02:32Z dgolden $
...
for var_index = 1:length(vars),
    ...
    elseif(isscalar(var_value)),
        ...
        if islogical(var_value)
          % Print 0s and 1s to save space, not true and false
          var_value = double(var_value);
        end
