function BatchPlotPKMaps(obj, output_dir)
...
if ~exist('output_dir', 'var') || isempty(output_dir)
  output_dir = fullfile(obj.Dirname, 'maps_pk');
end
...
for kk = 1:length(patient_ids)
  ...
  PlotPKMaps(PDMI, 'h_fig', gcf);
  
  output_filename = fullfile(output_dir, sprintf('parp_%s_pk.png', patient_id_tostr(patient_ids(kk))));
