function [moving_reg, tform] = imregister_dan(varargin)
%   Dan's version of imregister which also returns the tform struct
...
addpath(fullfile(matlabroot, 'toolbox', 'images', 'images', 'private'));
